...
<head>
	...
	<title>Подарки мужчине, женщине, ребёнку Донецк Макеевка ДНР | Мастерская подарков</title>
									...
									<ul data-spollers="768,max" class="menu__list">
										...
										<?php if (!empty($this->menu['catalog'])) : ?>
											...
											<li class="menu__item">
												...
												<button data-spoller type="button" class="menu__link">Подарки</button>
										...
										<?php if (!empty($this->phones)) : ?>
											...
											<li class="menu__item">
												...
												<button data-spoller type="button" class="menu__link-cat" style="margin-bottom: 0; cursor: auto; font-weight: 700; font-size: 22px; color: #c86506;">Позвонить</button>
										...
										<?php if (!empty($this->emails)) : ?>
											...
											<li class="menu__item">
												...
												<button data-spoller type="button" class="menu__link-cat" style="margin-bottom: 0; cursor: auto; font-weight: 700; font-size: 22px; color: #c86506;">Написать</button>
										...
										<?php if (!empty($this->menu['information'])) : ?>
											...
											<?php foreach ($this->menu['information'] as $item) : ?>
												...
												<li class=" menu__item">
																...
																<a href="<?= $this->alias(['information' => $item['alias']]) ?>" class="menu__link" style="color: #d00000"><?= $item['name'] ?></a>
